...
* ![Configuration de l'import des traductions](./support/003-fichier-de-trad-fr.png)
...
* ![choix de langue et sauvegarde configuration](./support/004-fichier-de-trad-fr.png)